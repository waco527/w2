...
class Helper
{
    ...
    public static function site_state($force_send = false, $current_blog_id = null)
    {
        ...
        if (!empty($state_data)) {
            ...
            $result = self::send_site_state($state_data);
    ...
    public static function send_site_state($data)
    {
