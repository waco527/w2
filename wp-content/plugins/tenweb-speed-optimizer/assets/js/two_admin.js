...
jQuery("document").ready(function () {
    ...
    jQuery("#lazy_load_type").change(function () {
        if (this.value === "browser") {
            ...
            jQuery(".two_bg_lazyload_cont, .two_bg_in_viewport_lazyload_cont").css({
                "display": "none"
            });
        } else {
    ...
    jQuery("#two_delay_all_js_execution").change(function () {
        if (this.checked) {
            ...
            jQuery(".two_timeout_js_load, .two_load_excluded_js_via_worker,.two_exclude_rev,.two_exclude_owl,.two_exclude_slick,.two_exclude_slider_by_10web,.two_exclude_elementor_scripts,.two_exclude_photo_gallery_by_10web,.two_exclude_google_ads,.two_exclude_amp_plugin_cdn").css({
                'display': 'block'
            });
    ...
    jQuery(".two_save_settings").click(function (e) {
        ...
        ajax_data['two_exclude_uncritical_fonts'] = jQuery("#two_exclude_uncritical_fonts").is(':checked') ? "on" : "";
