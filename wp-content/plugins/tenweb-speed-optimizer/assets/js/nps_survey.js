jQuery(document).ready(function() {
    ...
    jQuery('.two-nps-close-button').on('click', function(e) {
        e.preventDefault();
        close_nps_survey();
    });
    ...
    jQuery('.two_nps_question .two-nps-close-button').on('click', function() {
        set_nps_data( '-1' );
    });
    jQuery('.two_nps_share_love .two-nps-close-button').on('click', function() {
        set_nps_data( '11' );
    });
...
function close_nps_survey() {
    jQuery('.two-nps-main-container').addClass('two-hidden');
}

function set_nps_data( nps_rate ) {
    let nps_from;
    nps_from = jQuery('.two-nps-main-container').data('two-nps-from');
    jQuery.ajax({
        type: 'POST',
