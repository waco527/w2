      ...
      <div class="two-disconnect-popup">
        <div class="two-disconnect-popup-body">
          ...
          <div class="two-disconnect-popup-content">
            <p>
              <?php _e('Disconnecting a website from ' . esc_html( TWO_SO_ORGANIZATION_NAME ) . ' will rollback all optimization and caching configurations and negatively affect your PageSpeed.', 'tenweb-speed-optimizer'); ?>
            </p>
            <p>
