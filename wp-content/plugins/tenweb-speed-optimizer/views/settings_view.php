...
$two_bg_in_viewport_lazyload_check = ($two_bg_in_viewport_lazyload == "on") ? 'checked' : '';
    ...
    <div class="two_settings wd-box-section">
        ...
        <form class="two_settings_form" action="" method="post">
            ...
            <div class="two_settings_tab two_tab_lazy">
                ...
                <div class="two_settings_option two_bg_in_viewport_lazyload_cont" style="<?php echo esc_attr( $show_bg_lazy_load ); ?>">
                    <input <?php echo esc_html( $two_bg_in_viewport_lazyload_check ); ?> type="checkbox" name="two_bg_in_viewport_lazyload" id="two_bg_in_viewport_lazyload">
                    <label for="two_bg_in_viewport_lazyload"
                           class="wd-label"><?php _e('Lazy Load for background images that are not in the viewport', 'tenweb-speed-optimizer'); ?></label>
                    <p class="description"><?php _e('This option activates lazy load for background images and excludes images in the viewport. To get images list in the viewport, generate critical CSS.', 'tenweb-speed-optimizer') ?></p>
                </div>
