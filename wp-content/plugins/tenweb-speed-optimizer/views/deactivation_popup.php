...
if ( !is_plugin_active('image-optimizer/tenweb-image-optimizer.php' ) ) {
    ...
    <div class="two-deactivate-popup">
        <div class="two-deactivate-popup-body">
            ...
            <div class="two-deactivate-popup-button-container">
                <a href="<?php echo esc_url(TENWEB_SO_DISCONNECT_DEACTIVATE_URL); ?>" class="two-button two-button-disconnect"><?php _e('DISCONNECT & DEACTIVATE', 'tenweb-speed-optimizer'); ?></a>
