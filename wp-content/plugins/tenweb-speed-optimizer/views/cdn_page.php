        ...
        <?php } else { ?>
             <div class="two-cdn-test-main-container">
                 ...
                 <div class="two-cdn-test-steps">
                     <p class="two-main-text"><?php echo wp_kses(__('We will create a copy of your<br> homepage in 2 minutes', 'tenweb-speed-optimizer'), array( 'br' => array()));?></p>
                     <p class="two-main-text"><?php echo wp_kses(__('The copy will be stored<br> on our servers with CDN', 'tenweb-speed-optimizer'), array( 'br' => array()));?></p>
                     <p class="two-main-text"><?php echo wp_kses(__('It will not affect the original<br> version and be deleted in 1 hour', 'tenweb-speed-optimizer'), array( 'br' => array()));?></p>
                 </div>
