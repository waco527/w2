...
class OptimizerWebPageCacheWP {
    ...
    function __construct(){
        ...
        if(isset($_GET["action"]) && $_GET["action"] === 'two_clear_page_cache') {  // phpcs:ignore
            add_action( "admin_init", array( $this, 'maybe_clear_page_cache' ) );
        }
    ...
    public function add_wp_cache_constant(){
        ...
        return !!file_put_contents($this->wp_config_file_path, $file_content); // phpcs:ignore
    }
    ...
    public function store_page_cache_configs() {
        ...
        return !!file_put_contents($this->page_cache_config_dir . '/config.json', json_encode($configs)); // phpcs:ignore
    }
