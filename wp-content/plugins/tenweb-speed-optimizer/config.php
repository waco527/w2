<?php
define('TENWEB_SO_VERSION', '2.15.18');
...
define('TENWEB_SO_HOSTED_ON_NGINX', isset($_SERVER["SERVER_SOFTWARE"]) && strpos(strtolower(sanitize_text_field($_SERVER["SERVER_SOFTWARE"])), 'nginx') !== false);
